      ...
      <AnimatePresence>
        ...
        >
          <div className="relative lg:p-10">
            ...
            <div className="mt-4 grid min-h-screen grid-rows-2 md:grid-rows-1 md:grid-cols-2 lg:grid-cols-3">
              <div className="lg:col-span-2 row-span-full ">
                <div
                  style={{ backgroundColor: postImageData.lightMuted }}
                  className={`stify-center relative 	 flex  h-full items-start lg:col-span-2`}
                >
                  <Image
                    layout="fill"
                    quality={100}
              ...
              <div className="bg-gray-50">
                <div className="p-5">
                  ...
                  <motion.div
                    ...
                    className="mt-4 text-xl  font-bold  capitalize"
                  >
                    {post.title}
                  </motion.div>
                    ...
                    {post.softwares?.split(",").map((software, i) => (
                      <Link href={`/?q=${software}`} key={software}>
                        <motion.a
                          ...
                          className="inline-flex flex-shrink-0 items-center gap-2 rounded-xl border bg-white p-2 px-3 text-indigo-400  transition-all  hover:border-indigo-400"
                        >
                    ...
                    {post.tags?.split(",").map((tag, i) => (
                      <Link href={`/?q=${tag}`} key={tag}>
                        <motion.a
                          ...
                          className="inline-flex  flex-shrink-0 items-center gap-1 rounded-xl border bg-white p-2 px-3  text-indigo-400 transition-all hover:border-indigo-400"
                        >
